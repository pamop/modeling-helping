...
if __name__ == '__main__':
	import cProfile
	cProfile.run('test_load()', "test_load.prof")
	# from line_profiler import LineProfiler
	# lp = LineProfiler()
	# lp.add_function(farmgame.Farm.__init__)   # add additional function to profile
	# lp_wrapper = lp(test_load)
	# lp_wrapper() # add args here
	# lp.print_stats()
